...
#pragma mark - app delegate notifications  监听系统生命周期
...
#pragma mark - register apns 注册推送
...
#pragma mark - send message  发送地理位置
...
#pragma mark - send message  发送普通图片
...
#pragma mark - send message  发送质量图片
+ (EMMessage *)sendImageMessageWithImage:(UIImage *)image
                                      to:(NSString *)to
                             messageType:(EMMessageType)messageType
                       requireEncryption:(BOOL)requireEncryption
