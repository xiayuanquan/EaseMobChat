...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    [_photoButton setFrame:CGRectMake(insets, 5, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    ...
    UILabel *photolabel = [UILabel createLabel:CGRectMake(insets, CGRectGetMaxY(_photoButton.frame)+2, CHAT_BUTTON_SIZE, 20) title:@"图片" titleColor:HMColor(51, 51, 51) alignmentType:NSTextAlignmentCenter size:13];
    [_scrollview addSubview:photolabel];
    [_scrollview addSubview:_photoButton];
    
    //位置
    _locationButton =[UIButton buttonWithType:UIButtonTypeCustom];
    [_locationButton setFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, 5, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    ...
    UILabel *locationlabel = [UILabel createLabel:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, CGRectGetMaxY(_locationButton.frame)+2, CHAT_BUTTON_SIZE, 20) title:@"位置" titleColor:HMColor(51, 51, 51) alignmentType:NSTextAlignmentCenter size:13];
    [_scrollview addSubview:locationlabel];
    [_scrollview addSubview:_locationButton];
    
    //相机
    _takePicButton =[UIButton buttonWithType:UIButtonTypeCustom];
    [_takePicButton setFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, 5, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    ...
    _maxIndex = 2;
    UILabel *takePicButtonlabel = [UILabel createLabel:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, CGRectGetMaxY(_takePicButton.frame)+2, CHAT_BUTTON_SIZE, 20) title:@"相机" titleColor:HMColor(51, 51, 51) alignmentType:NSTextAlignmentCenter size:13];
    [_scrollview addSubview:takePicButtonlabel];
    ...
    if (type == EMChatToolbarTypeChat) {
        ...
        [_audioCallButton setFrame:CGRectMake(insets * 4 + CHAT_BUTTON_SIZE * 3, 5, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
        ...
        UILabel *audioCallButtonlabel = [UILabel createLabel:CGRectMake(insets * 4 + CHAT_BUTTON_SIZE * 3, CGRectGetMaxY(_audioCallButton.frame)+2, CHAT_BUTTON_SIZE, 20) title:@"电话" titleColor:HMColor(51, 51, 51) alignmentType:NSTextAlignmentCenter size:13];
        [_scrollview addSubview:audioCallButtonlabel];
        ...
        _maxIndex = 4;
        UILabel *videoCallButtonlabel = [UILabel createLabel:CGRectMake(insets, CGRectGetMaxY(_videoCallButton.frame)+2, CHAT_BUTTON_SIZE, 20) title:@"视屏" titleColor:HMColor(51, 51, 51) alignmentType:NSTextAlignmentCenter size:13];
        [_scrollview addSubview:videoCallButtonlabel];
