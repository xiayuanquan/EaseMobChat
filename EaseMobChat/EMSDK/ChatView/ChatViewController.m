...
{
    self.navigationItem.leftBarButtonItem = [UIBarButtonItem itemWithImageName:@"back" target:self action:@selector(backAction)];
    
    //单聊
    if (self.conversation.conversationType == eConversationTypeChat) {
        self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithImageName:@"whiteclear" target:self action:@selector(deleteAllMessages:)];
    }
//    else{//群聊
